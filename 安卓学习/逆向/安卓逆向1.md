...
> 参考：
>
> [ **52pj--利用内嵌模块hook设备信息** ](https://www.52pojie.cn/forum.php?mod=viewthread&tid=1798397&highlight=%A1%B6%B0%B2%D7%BF%C4%E6%CF%F2%D5%E2%B5%B5%CA%C2%A1%B7)
...
>   >
>   > 去[Arm2Hex](https://armconverter.com/)网站查看转换是否正确
>   >
>   > ![1693556737143](安卓逆向1.assets/1693556737143.png)
>   >
>   > 通过在网站修改`arm汇编`代码，得到新的hex
>   >
>   > ![1693556843208](安卓逆向1.assets/1693556843208.png)
>   >
>   > **返回ida修改，并且apply**
>   
>   使用任一方式修改完之后，将修改后的`so`文件覆盖掉原来的so，然后回编译并签名，安装
>   
>   > 参考：[修改so并回编译、签名](https://www.cnblogs.com/xiaoweigege/p/15000347.html)
>   
>   **注意：模拟器是windows平台，所以要修改`x86`目录下的so；真机修改`arm`目录下的so**

### (2)so调试与反调试

> 参控：https://www.52pojie.cn/t5hread-1809646-1-1.html
